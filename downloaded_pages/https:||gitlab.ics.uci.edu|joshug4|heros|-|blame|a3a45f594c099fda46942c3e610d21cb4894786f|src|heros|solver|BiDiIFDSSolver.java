...
a3a45f594c099fda46942c3e610d21cb4894786f
...
43
		IFDSSolver<N,AbstractionWithSourceStmt<N,D>,M,I> fwSolver = new SingleDirectionSolver(forwardProblem,"FW");IFDSSolver<N,AbstractionWithSourceStmt<N,D>,M,I>fwSolver=newSingleDirectionSolver(forwardProblem,"FW");
...
45
		IFDSSolver<N,AbstractionWithSourceStmt<N,D>,M,I> bwSolver = new SingleDirectionSolver(backwardProblem,"BW");IFDSSolver<N,AbstractionWithSourceStmt<N,D>,M,I>bwSolver=newSingleDirectionSolver(backwardProblem,"BW");
...
51
		fwSolver.solve();fwSolver.solve();	}}		private class SingleDirectionSolver extends IFDSSolver<N, AbstractionWithSourceStmt<N, D>, M, I> {privateclassSingleDirectionSolverextendsIFDSSolver<N,AbstractionWithSourceStmt<N,D>,M,I>{
...
54
		private final String debugName;privatefinalStringdebugName;		private SingleDirectionSolver(IFDSTabulationProblem<N, AbstractionWithSourceStmt<N, D>, M, I> ifdsProblem, String debugName) {privateSingleDirectionSolver(IFDSTabulationProblem<N,AbstractionWithSourceStmt<N,D>,M,I>ifdsProblem,StringdebugName){
