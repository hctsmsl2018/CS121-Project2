...
d62317883b7f57585a3d450bc516f272e628c323
...
import heros.util.SootThreadGroup;importheros.util.SootThreadGroup;
...
import java.util.concurrent.BlockingQueue;importjava.util.concurrent.BlockingQueue;
...
import java.util.concurrent.ThreadFactory;importjava.util.concurrent.ThreadFactory;
...
34
	...
	protected volatile Throwable exception = null;protectedvolatileThrowableexception=null;
...
37
	...
	public CountingThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit,publicCountingThreadPoolExecutor(intcorePoolSize,intmaximumPoolSize,longkeepAliveTime,TimeUnitunit,			BlockingQueue<Runnable> workQueue) {BlockingQueue<Runnable>workQueue){
...
44
		...
		super(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, new ThreadFactory() {super(corePoolSize,maximumPoolSize,keepAliveTime,unit,workQueue,newThreadFactory(){						@Override@Override			public Thread newThread(Runnable r) {publicThreadnewThread(Runnabler){				return new Thread(new SootThreadGroup(), r);returnnewThread(newSootThreadGroup(),r);			}}		});});
...
71
		...
		else {else{			numRunningTasks.decrement();numRunningTasks.decrement();		}}
